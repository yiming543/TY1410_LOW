...
void LED_output(void) {
  ...
  if (csFlag.LoBeam == 0 && csFlag.HiBeam == 0 && csFlag.DRL == 0) {
    ...
    if (CCPR1L != 49) {
      CCPR1L = 124;
      do { LATAbits.LATA0 = 1; } while(0);
      _delay((unsigned long)((8)*(32000000/4000.0)));
      EPWM1_LoadDutyValue((199));
    }
  } else if (csFlag.LoBeam == 0 && csFlag.HiBeam == 1 && csFlag.DRL == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM1_LoadDutyValue((499));
  } else if (csFlag.LoBeam == 0 && csFlag.HiBeam == 1 && csFlag.DRL == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM1_LoadDutyValue((499));
  } else if (csFlag.LoBeam == 1 && csFlag.HiBeam == 0 && csFlag.DRL == 0) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM1_LoadDutyValue((499));
  } else if (csFlag.LoBeam == 1 && csFlag.HiBeam == 0 && csFlag.DRL == 1) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM1_LoadDutyValue((499));
  } else if (csFlag.LoBeam == 1 && csFlag.HiBeam == 1 && csFlag.DRL == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM1_LoadDutyValue((499));
  } else if (csFlag.LoBeam == 1 && csFlag.HiBeam == 1 && csFlag.DRL == 1) {
