...
extern void sofaware_initialize(void);

extern _Bool fLamp_Conf;
...
const uint8_t UART_LEVEL = 25;
const uint8_t BUF_LENGTH = 11;
const uint8_t RISING_EDGE_TRIG = 5;
const uint8_t FALLING_EDGE_TRIG = 4;
...
void P2_POS2_ON(void);
void P2_POS2_OFF(void);
void HIBEAM_ON(void);
...
void LED_control_HiPe(void);
void LED_control_LoPe(void);
...
uint8_t rx_buf[11];
uint8_t rx_data = 0;
volatile _Bool fReceiver_Byte = 0;
volatile _Bool fFrame_OK = 0;
volatile uint8_t Communication_timer = 0;
...
void LED_control_HiPe(void) {
  ...
  if (csFlag.LoBeam == 0 && csFlag.HiBeam == 0 && csFlag.DRL == 0 && csFlag.POS == 0) {
    LOBEAM_OFF();
    HIBEAM_OFF();
    DRL_POS_OFF_HiPe();
...
void LED_control_LoPe(void) {
  ...
  if (csFlag.LoBeam == 0 && csFlag.HiBeam == 0 && csFlag.DRL == 0) {

    HIBEAM_OFF();
    EPWM1_LoadDutyValue((0));
  } else if (csFlag.LoBeam == 0 && csFlag.HiBeam == 0 && csFlag.DRL == 1) {

    if (CCPR1L == 0) {
      HIBEAM_OFF();
      EPWM1_LoadDutyValue((320));
    } else if (CCPR1L != 80) {
      HIBEAM_OFF();
      EPWM1_LoadDutyValue((804));
      _delay((unsigned long)((10)*(32000000/4000.0)));
      EPWM1_LoadDutyValue((640));
      _delay((unsigned long)((10)*(32000000/4000.0)));
      EPWM1_LoadDutyValue((480));
      _delay((unsigned long)((10)*(32000000/4000.0)));
      EPWM1_LoadDutyValue((320));
    }
